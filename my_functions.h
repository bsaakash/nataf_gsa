...
extern void nataf_transf(int nmc, int nrv, int nco, int nqoi, vector<std::string>& get_distnames, vector<std::string>& get_opts,
	vector<vector<double>>& get_vals, vector<double>& get_const, vector<std::string>& get_rvnames, vector<double>& get_corr, vector<vector<double>>& get_add, std::string& workdir, coder::array<double, 2U>& u_temp,
