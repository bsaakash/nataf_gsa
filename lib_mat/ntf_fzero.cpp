...
// Return Type  : void
//
void ntf_b_fzero(const ntf_c_coder_internal_anonymous_ FunFcn, double x, double *
...
// Return Type  : void
//
void ntf_c_fzero(const double x[2], const coder::array<double, 1U> &varargin_1,
...
// Return Type  : void
//
void ntf_d_fzero(const ntf_d_coder_internal_anonymous_ *FunFcn, double x, double
                 *b, double *fval, double *exitflag)
{
  double fx;
  double dx;
...
// Return Type  : void
//
void ntf_fzero(const ntf_c_coder_internal_anonymous_ FunFcn, double *b, double
