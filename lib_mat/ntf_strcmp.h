...
extern boolean_T ntf_g_strcmp(const coder::array<char, 2U> &a);
extern boolean_T ntf_h_strcmp(const coder::array<char, 2U> &a);
extern boolean_T ntf_i_strcmp(const coder::array<char, 2U> &a);
extern boolean_T ntf_j_strcmp(const coder::array<char, 2U> &a);
extern boolean_T ntf_k_strcmp(const coder::array<char, 2U> &a);
extern boolean_T ntf_l_strcmp(const coder::array<char, 2U> &a);
extern boolean_T ntf_m_strcmp(const coder::array<char, 2U> &a);
extern boolean_T ntf_n_strcmp(const coder::array<char, 2U> &a);
extern boolean_T ntf_o_strcmp(const coder::array<char, 2U> &a);
