...
//
boolean_T ntf_ab_strcmp(const coder::array<char, 2U> &a, const char b[8])
{
  boolean_T b_bool;
  b_bool = false;
  if (a.size(1) == 8) {
...
// Return Type  : boolean_T
//
boolean_T ntf_bb_strcmp(const coder::array<char, 2U> &a)
{
  boolean_T b_bool;
  b_bool = false;
  if (a.size(1) == 9) {
...
{
  boolean_T b_bool;
  static const char b_cv[7] = { 'f', 'r', 'e', 'c', 'h', 'e', 't' };
...
{
  boolean_T b_bool;
  static const char b_cv[6] = { 'g', 'e', 'v', 'm', 'i', 'n' };
...
// Return Type  : boolean_T
//
boolean_T ntf_s_strcmp(const coder::array<char, 2U> &a)
{
  boolean_T b_bool;
  static const char b_cv[6] = { 'p', 'a', 'r', 'e', 't', 'o' };
...
// Return Type  : boolean_T
//
boolean_T ntf_t_strcmp(const coder::array<char, 2U> &a)
{
  boolean_T b_bool;
...
// Return Type  : boolean_T
//
boolean_T ntf_u_strcmp(const coder::array<char, 2U> &a)
{
  boolean_T b_bool;
...
// Return Type  : boolean_T
//
boolean_T ntf_v_strcmp(const coder::array<char, 2U> &a)
{
  boolean_T b_bool;
...
// Return Type  : boolean_T
//
boolean_T ntf_w_strcmp(const coder::array<char, 2U> &a, const char b[14])
{
  boolean_T b_bool;
  b_bool = false;
  if (a.size(1) == 14) {
...
// Return Type  : boolean_T
//
boolean_T ntf_x_strcmp(const coder::array<char, 2U> &a, const char b[16])
{
  boolean_T b_bool;
  b_bool = false;
  if (a.size(1) == 16) {
...
// Return Type  : boolean_T
//
boolean_T ntf_y_strcmp(const coder::array<char, 2U> &a, const char b[6])
{
  boolean_T b_bool;
  b_bool = false;
  if (a.size(1) == 6) {
