...
// Return Type  : void
//
void ntf_ab_pdf(const coder::array<double, 1U> &x, double varargin_1, coder::
                array<double, 1U> &y)
{
  int i;
  y.set_size(x.size(0));
...
// Return Type  : void
//
void ntf_b_pdf(const double x[1000], double varargin_1, double varargin_2,
               double y[1000])
{
  double d;
  double d1;
...
// Return Type  : void
//
void ntf_bb_pdf(const coder::array<double, 1U> &x, double varargin_1, coder::
                array<double, 1U> &y)
{
  int i;
  double b_y;
...
// Return Type  : void
//
void ntf_c_pdf(const double x[1000], double varargin_1, double y[1000])
{
  double b_x;
  for (int k = 0; k < 1000; k++) {
    if ((varargin_1 >= 0.0) && (!rtIsNaN(x[k]))) {
...
// Return Type  : void
//
void ntf_cb_pdf(const coder::array<double, 1U> &x, double varargin_1, double
...
// Return Type  : void
//
void ntf_d_pdf(const double x[1000], double varargin_1, double varargin_2,
               double y[1000])
{
  double b_y;
  for (int k = 0; k < 1000; k++) {
...
// Return Type  : void
//
void ntf_db_pdf(const coder::array<double, 1U> &x, double varargin_1, double
                varargin_2, coder::array<double, 1U> &y)
{
  int i;
  y.set_size(x.size(0));
...
// Return Type  : void
//
void ntf_e_pdf(const double x[1000], double varargin_1, double varargin_2,
               double y[1000])
{
  double b_logb;
  double absz;
...
// Return Type  : void
//
void ntf_eb_pdf(const coder::array<double, 1U> &x, double varargin_1, double
                varargin_2, coder::array<double, 1U> &y)
{
  int i;
  y.set_size(x.size(0));
...
// Return Type  : void
//
void ntf_f_pdf(const double x[1000], double varargin_1, double varargin_2,
               double varargin_3, double y[1000])
{
...
// Return Type  : void
//
void ntf_g_pdf(const double x[1000], double varargin_1, double varargin_2,
               double y[1000])
{
  for (int k = 0; k < 1000; k++) {
...
// Return Type  : void
//
void ntf_h_pdf(const double x[1000], double varargin_1, double varargin_2,
               double y[1000])
{
  for (int k = 0; k < 1000; k++) {
    if (varargin_2 > 0.0) {
...
// Return Type  : void
//
void ntf_i_pdf(const double x[5000], double varargin_1, double varargin_2,
               double y[5000])
{
  double d;
  double d1;
...
// Return Type  : void
//
void ntf_j_pdf(const double x[5000], double varargin_1, double varargin_2,
               double y[5000])
{
  double d;
  double d1;
...
// Return Type  : void
//
void ntf_k_pdf(const double x[5000], double varargin_1, double y[5000])
{
  double b_x;
  for (int k = 0; k < 5000; k++) {
    if ((varargin_1 >= 0.0) && (!rtIsNaN(x[k]))) {
...
// Return Type  : void
//
void ntf_l_pdf(const double x[5000], double varargin_1, double varargin_2,
               double y[5000])
{
  double b_y;
  for (int k = 0; k < 5000; k++) {
...
// Return Type  : void
//
void ntf_m_pdf(const double x[5000], double varargin_1, double varargin_2,
               double y[5000])
{
  double b_logb;
  double absz;
...
// Return Type  : void
//
void ntf_n_pdf(const double x[5000], double varargin_1, double varargin_2,
               double varargin_3, double y[5000])
{
...
// Return Type  : void
//
void ntf_o_pdf(const double x[5000], double varargin_1, double varargin_2,
               double y[5000])
{
  for (int k = 0; k < 5000; k++) {
    if ((varargin_1 > 0.0) && (varargin_2 > 0.0)) {
...
// Return Type  : void
//
void ntf_p_pdf(const double x[5000], double varargin_1, double varargin_2,
               double y[5000])
{
  for (int k = 0; k < 5000; k++) {
    if (varargin_2 > 0.0) {
...
// Return Type  : void
//
void ntf_pdf(const double x[1000], double varargin_1, double varargin_2, double
             y[1000])
{
  double d;
  double d1;
...
// Return Type  : void
//
void ntf_q_pdf(const coder::array<double, 1U> &x, double varargin_1, double
               varargin_2, coder::array<double, 1U> &y)
{
  int i;
  double d;
...
// Return Type  : void
//
void ntf_r_pdf(const coder::array<double, 1U> &x, double varargin_2, coder::
               array<double, 1U> &y)
{
  int i;
  double lognk_tmp;
...
// Return Type  : void
//
void ntf_s_pdf(const coder::array<double, 1U> &x, double varargin_1, double
               varargin_2, coder::array<double, 1U> &y)
{
  int i;
  double d;
...
// Return Type  : void
//
void ntf_t_pdf(const coder::array<double, 1U> &x, double varargin_1, coder::
               array<double, 1U> &y)
{
  int i;
  double b_x;
...
// Return Type  : void
//
void ntf_u_pdf(const coder::array<double, 1U> &x, double varargin_1, coder::
               array<double, 1U> &y)
{
  int i;
  y.set_size(x.size(0));
...
// Return Type  : void
//
void ntf_v_pdf(const coder::array<double, 1U> &x, double varargin_1, double
               varargin_2, coder::array<double, 1U> &y)
{
  int i;
  double b_logb;
...
// Return Type  : void
//
void ntf_w_pdf(const coder::array<double, 1U> &x, double varargin_2, double
...
// Return Type  : void
//
void ntf_x_pdf(const coder::array<double, 1U> &x, double varargin_1, double
               varargin_2, coder::array<double, 1U> &y)
{
  int i;
  y.set_size(x.size(0));
...
// Return Type  : void
//
void ntf_y_pdf(const coder::array<double, 1U> &x, double varargin_1, double
