...
extern void ntf_cdf(const coder::array<double, 1U> &varargin_1, double
                    varargin_2, double varargin_3, coder::array<double, 1U> &p);
extern void ntf_d_cdf(const coder::array<double, 1U> &varargin_1, double
                      varargin_2, coder::array<double, 1U> &p);
extern void ntf_e_cdf(const coder::array<double, 1U> &varargin_1, double
                      varargin_2, coder::array<double, 1U> &p);
extern double ntf_eml_erfcore(double x);
extern void ntf_f_cdf(const coder::array<double, 1U> &varargin_1, double
                      varargin_2, double varargin_3, coder::array<double, 1U> &p);
