...
// File: gsa_combineVectorElements.cpp
//
...
// Return Type  : void
//
void gsa_combineVectorElements(const coder::array<double, 2U> &x, coder::array<
  double, 2U> &y)
{
  int vlen;
  vlen = x.size(0);
...
//
// File trailer for gsa_combineVectorElements.cpp
//
// [EOF]
//
